                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, jszipInstance.loadAsync(d.zip.data)];
                        case 1:
                            _c.sent();
                            list_1 = [];
                        ...
                        case 2:
                            ...
                            n = _a[_i];
                            entry = list_1[n];
                            if (!(entry.name.indexOf('.png') != -1)) return [3 /*break*/, 4];
                            return [4 /*yield*/, entry.async('base64')];
                        case 3:
                            base64 = _c.sent();
                            spritesheetImageData = "data:image/png;base64," + base64;
                            return [3 /*break*/, 6];
                        case 4:
                            if (!(entry.name.indexOf('.json') != -1)) return [3 /*break*/, 6];
