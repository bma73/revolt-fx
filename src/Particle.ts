...
import {IParticle, IParticleSettings, RevoltEffects} from "./RevoltEffects";
...
export class Particle extends Node implements IParticle {
    ...
    public spawnOnComplete: ParticleEmitter;
    ...
    public init(emitter: ParticleEmitter, settings: IParticleSettings) {
        ...
        if (settings.randomStartRotation) component.rotation = Rnd.float(0, 6.28319);
        ...
        if (this.useGravity) {
            ...
            this.distanceEase = (Easing as any)[settings.distanceEase] || null;
        }
        ...
        if (this.useScale) {
            ...
            this.scaleEase = (Easing as any)[settings.scaleEase] || null;
        }
        ...
        if (this.useTint) {
            this.tintEase = (Easing as any)[settings.tintEase] || null;
