...
export class FX {
     ...
     */
    loadBundleFiles(bundleSettingsUrl_1, spritesheetUrl_1) {
        return __awaiter(this, arguments, void 0, function* (bundleSettingsUrl, spritesheetUrl, spritesheetFilter = '', additionalAssets = []) {
            const data = {
