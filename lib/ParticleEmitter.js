    ...
    spawn() {
        ...
        while (--n > -1) {
            ...
            switch (ps.component.componentType) {
                case 0:
                    p.componentId = ps.component.componentId;
                ...
                case 1:
                    ...
                    if (ps.component.componentParams) {
                        component.loop = ps.component.componentParams.loop == null || !ps.component.componentParams.loop ? false : true;
                        component.animationSpeed = Rnd.float(ps.component.componentParams.animationSpeedMin || 1, ps.component.componentParams.animationSpeedMax || 1);
                    }
